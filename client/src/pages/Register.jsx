...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    axios.post("http://localhost:5000/users/register", registered).then((response) => {
  ...
  return (
    <>
      ...
      <Container>
        <Wrapper>
          <HeroTitle>Sign up to QUIZIFY for free</HeroTitle>
          <Title>Register to create and manage online tests, quizzes and assessments with Quizify.</Title>
          <FormWrapper>
